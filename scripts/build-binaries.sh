...
env CGO_ENABLED=0 GOOS=linux GOARCH=mips GOMIPS=softfloat go build -ldflags "-s -w" -o build/netclient-mips-softfloat/netclient main.go && upx build/netclient-mips-softfloat/netclient
